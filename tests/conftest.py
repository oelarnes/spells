...
FAKE_CARD_ATTR_ROWS = [
    ...
    },
    {
        ...
        "is_bonus_sheet": False,
        "is_dfc": False,
        "oracle_text": "Flying. When ETB, deal 2 damage.",
        "card_json": "{}",
        "scryfall_id": "",
        "image_url": "",
    },
...
def _tst_draft_rows():
    ...
    return [
        ...
        _make_draft_row(
            ...
            0,
            "Blazing Howl",
            draft_time="2026-01-02 14:00:00",
            **_BOTTOM,
        ),
        _make_draft_row(
            "TST",
        ...
        _make_draft_row(
            ...
            0,
            "Tidal Reckoning",
            draft_time="2026-01-08 10:00:00",
            **_MIDDLE,
        ),
        _make_draft_row(
            "TST",
        ...
        _make_draft_row(
            ...
            0,
            "Crystal Idol",
            draft_time="2026-01-09 11:00:00",
            **_OTHER,
        ),
        _make_draft_row(
            "TST",
        ...
        _make_draft_row(
            ...
            0,
            "Tidal Reckoning",
            draft_time="2026-01-15 09:00:00",
            **_TOP,
        ),
    ]
...
def _tla_draft_rows():
    ...
    return [
        ...
        _make_draft_row(
            ...
            1,
            "Blazing Howl",
            draft_time="2026-01-16 09:00:00",
            **_OTHER,
        ),
    ]
...
FAKE_CARD_RATINGS_2 = [
    {
        ...
        "never_drawn_game_count": 100,
        "never_drawn_win_rate": 0.52,
    },
    {
        "name": "Tidal Warden",
        "color": "U",
        ...
        "drawn_game_count": 65,
        "drawn_win_rate": 0.57,
        "ever_drawn_game_count": 110,
        "ever_drawn_win_rate": 0.59,
        "never_drawn_game_count": 110,
        "never_drawn_win_rate": 0.57,
    },
]


@pytest.fixture()
def fake_ratings_file(
    tmp_path: Path, monkeypatch: pytest.MonkeyPatch
) -> Generator[Path, None, None]:
    monkeypatch.setenv("SPELLS_DATA_HOME", str(tmp_path))
